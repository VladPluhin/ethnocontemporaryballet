          ...
          return (
            <SwiperSlide key={slide.title + id}>
              <div className="bg-image" style={{ backgroundColor: "#000" }}>
                {slide?.slideBgImage?.url && (
                  <img
                    src={slide?.slideBgImage.url}
                    alt={slide.slideBgImage?.description}
                  />
                )}
                {slide?.layerOnImage && (
                  <span
                    ...
                    style={{
                      backgroundColor: slide.layerOnImage
                        ? slide.layerOnImage
                        : "",
                    }}
                  ></span>
                  ...
                  <div className="description">
                    {slide?.title && (
                      <h1
                        className="title"
                        style={{
                          color: slide.colorText ? slide.colorText : "",
                        }}
                      >
                        {slide.title}
                      </h1>
